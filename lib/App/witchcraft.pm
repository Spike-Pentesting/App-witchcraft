...
use App::witchcraft::Utils qw(daemonize);
...
sub on_load {
    ...
    # ENV overrides
    foreach my $param (
        qw(DEPGRAPH_ATOM FOLLOW_VERSIONING GIT_REPOSITORY OVERLAY_NAME IRC_SERVER IRC_PORT IRC_CHANNELS IRC_NICKNAME IRC_IDENT IRC_REALNAME)
        )
    {
